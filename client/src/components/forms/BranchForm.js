...
function BranchForm({ handleSubmit, handleChange, validateMessages, values }) {
	...
	return (
		<Fragment>
			<Form {...layout} onSubmitCapture={handleSubmit} layout="horizontal" validateMessages={validateMessages}>
				<Form.Item
					label="Branch Name"
					rules={[
						{
				...
				>
					<Input name="addressLine" value={addressLine} onChange={handleChange} />
				</Form.Item>
				<Form.Item
				...
				>
					<Input name="district" value={district} onChange={handleChange} />
				</Form.Item>
				<Form.Item
					label="country البلد"
					rules={[
				...
				>
					<Input name="province" value={province} onChange={handleChange} />
				</Form.Item>

				<Form.Item label="present " className="text-primary">
					<select
						name="present"
						// showSearch
				...
				>
					<select name="trAvailable" className="form-control  w-50" onChange={handleChange}>
						<option>Please select</option>
